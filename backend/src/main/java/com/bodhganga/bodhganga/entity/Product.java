...
public class Product {
    ...
    public Boolean getImportedFromDrive() {
        return importedFromDrive;
    }

    public void setImportedFromDrive(Boolean importedFromDrive) {
        this.importedFromDrive = importedFromDrive;
    }
    ...
    public static String stripExtension(String fileName) {
        ...
        if (lastDot > 0) {
            ...
            if (java.util.List.of("pdf", "doc", "docx", "xls", "xlsx", "ppt", "pptx", "png", "jpg", "jpeg", "webp",
                    "mp3", "m4a", "wav", "ogg", "aac", "flac", "zip", "txt", "mp4", "avi", "mkv", "mov")
                    .contains(ext)) {
    ...
    public static String determineContentType(String mimeType, String fileName) {
        if (mimeType != null) {
            ...
            if (mt.equals("application/msword")
                ...
                return "DOCUMENT";
            if (mt.equals("application/vnd.ms-excel")
                    || mt.equals("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"))
                return "SPREADSHEET";
            if (mt.equals("application/vnd.ms-powerpoint")
                    || mt.equals("application/vnd.openxmlformats-officedocument.presentationml.presentation"))
                return "PRESENTATION";
            if (mt.equals("image/webp"))
                return "IMAGE";
            if (mt.equals("application/zip") || mt.equals("application/x-zip-compressed"))
                return "ZIP";
