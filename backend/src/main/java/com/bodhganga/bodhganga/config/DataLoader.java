...
/**
 * Data loader to populate sample courses and products in the database on
 * startup
 */
@Component
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info("Cleaned up {} unverified and {} incomplete temporary users from database.", deletedCount1,
                deletedCount2);
    ...
    private void ensureAdminUser() {
        ...
        String adminPhone = configuredAdminPhone != null ? configuredAdminPhone.replaceAll("[^0-9]", "") : "";
        if (adminPhone.startsWith("91") && adminPhone.length() == 12) {
            adminPhone = adminPhone.substring(2);
        }

        final String targetPhone = adminPhone;

        var query = targetPhone.isBlank() ? userRepo.findByEmail(adminEmail)
                : userRepo.findByPhoneNo(targetPhone).or(() -> userRepo.findByEmail(adminEmail));
        ...
        query.ifPresentOrElse(
                user -> {
                    ...
                    if (!targetPhone.isBlank() && !targetPhone.equals(user.getPhoneNo())) {
                    ...
                    if (changed) {
                        userRepo.save(user);
                        log.info("Updated existing admin user in MongoDB: email={}", adminEmail);
                    } else {
                ...
                () -> {
                    User admin = User.builder()
                            .name("Admin")
                            .email(adminEmail)
                            .phoneNo(targetPhone.isBlank() ? null : targetPhone)
    ...
    private void seedProducts() {
        List<Product> products = Arrays.asList(
                createProduct("Rajasthan PSC Complete History Notes",
                        "Comprehensive PDF notes covering Ancient, Medieval, and Modern History of Rajasthan for RPSC exams.",
                        "Rajasthan", "Notes", 99.0,
                        "https://images.unsplash.com/photo-1596524430615-b46475ddff6e?w=800", "rpsc-history-notes.pdf"),
                createProduct("Bihar Special Geography & Economy Blueprint",
                        "Key geography topics and economy analysis of Bihar, tailormade for BPSC civil services preparation.",
                        "Bihar", "Notes", 99.0, "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=800",
                        "bpsc-geography-economy.pdf"),
                createProduct("Uttar Pradesh General Knowledge Question Bank",
                        "Over 1000 high-yield multiple choice questions with detailed explanations for UPPSC and subordinate exams.",
                        "Uttar Pradesh", "Question Bank", 99.0,
                        "https://images.unsplash.com/photo-1509228627152-72ae9ae6848d?w=800",
                        "uppsc-gk-question-bank.pdf"),
                createProduct("Madhya Pradesh Tribe & Culture Companion",
                        "Specialized guide to tribes, folk dances, art forms, and cultural heritage of MP for MPPSC candidates.",
                        "Madhya Pradesh", "Notes", 99.0,
                        "https://images.unsplash.com/photo-1580853039692-835f8d0a8b68?w=800",
                        "mppsc-tribes-culture.pdf"),
                createProduct("Ultimate General Studies Mock Test Series",
                        "Full-length mock test papers with detailed answers covering history, polity, geography, and general science.",
                        "All India", "Bundle", 99.0,
                        "https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=800",
                        "gs-mock-test-series.pdf"));

        productRepo.saveAll(products);
        log.info("Successfully loaded {} sample products into database", products.size());
    }

    private Product createProduct(String title, String description, String state, String type, Double price,
            String previewUrl, String storageKey) {
    ...
    private List<State> buildCanonicalMasterStates() {
        return Arrays.asList(
                createState("andhra-pradesh", "AP", "Andhra Pradesh", "Amaravati",
                        ...
                        "STATE",
                        Arrays.asList("Alluri Sitharama Raju", "Anakapalli", "Ananthapuramu", "Chittoor",
                                "East Godavari", "Eluru", "Guntur", "Kakinada", "Konaseema", "Krishna", "Kurnool",
                                "Manyam", "NTR", "Nandyal", "Palnadu", "Prakasam", "Srikakulam",
                                "Sri Potti Sriramulu Nellore", "Sri Sathya Sai", "Tirupati", "Visakhapatnam",
                                "Vizianagaram", "West Godavari", "YSR Kadapa")),
                createState("arunachal-pradesh", "AR", "Arunachal Pradesh", "Itanagar",
                        "Study materials for Arunachal Pradesh Public Service Commission and state-level examinations.",
                        "STATE",
                        Arrays.asList("Anjaw", "Changlang", "Dibang Valley", "East Kameng", "East Siang", "Kamle",
                                ...
                                "West Siang")),
                createState("assam", "AS", "Assam", "Dispur",
                        "Complete study resource for Assam Public Service Commission and various state government examinations.",
                        "STATE",
                        Arrays.asList("Bajali", "Baksa", "Barpeta", "Biswanath", "Bongaigaon", "Cachar", "Charaideo",
                                ...
                                "West Karbi Anglong")),
                createState("bihar", "BR", "Bihar", "Patna",
                        "Extensive preparation material for Bihar PSC, Police, Sub-Inspector, and Staff Selection Commission examinations.",
                        "STATE",
                        Arrays.asList("Araria", "Arwal", "Aurangabad", "Banka", "Begusarai", "Bhagalpur", "Bhojpur",
                ...
                createState("chhattisgarh", "CT", "Chhattisgarh", "Raipur",
                        "Comprehensive notes and questions for Chhattisgarh Public Service Commission and state exams.",
                        "STATE",
                        Arrays.asList("Balod", "Baloda Bazar", "Balrampur", "Bastar", "Bemetara", "Bijapur", "Bilaspur",
                                "Dantewada", "Dhamtari", "Durg", "Gariaband", "Gaurela-Pendra-Marwahi",
                                "Janjgir-Champa", "Jashpur", "Kabirdham", "Kanker", "Kondagaon", "Korba", "Korea",
                ...
                createState("goa", "GA", "Goa", "Panaji",
                        "Study materials for Goa Public Service Commission and state government examinations.", "STATE",
                        Arrays.asList("North Goa", "South Goa")),
                createState("gujarat", "GJ", "Gujarat", "Gandhinagar",
                        "Complete resource for Gujarat PSC, Police, Transport, and Staff Selection Board examinations.",
                        "STATE",
                        Arrays.asList("Ahmedabad", "Amreli", "Anand", "Aravalli", "Banaskantha", "Bharuch", "Bhavnagar",
                                "Botad", "Chhota Udepur", "Dahod", "Dang", "Devbhumi Dwarka", "Gandhinagar",
                                "Gir Somnath", "Jamnagar", "Junagadh", "Kheda", "Kutch", "Mahisagar", "Mehsana",
                                "Morbi", "Narmada", "Navsari", "Panchmahal", "Patan", "Porbandar", "Rajkot",
                                "Sabarkantha", "Surat", "Surendranagar", "Tapi", "Vadodara", "Valsad")),
                createState("haryana", "HR", "Haryana", "Chandigarh",
                        "Preparation material for Haryana Public Service Commission and Staff Selection Commission exams.",
                        "STATE",
                        Arrays.asList("Ambala", "Bhiwani", "Charkhi Dadri", "Faridabad", "Fatehabad", "Gurugram",
                                "Hisar", "Jhajjar", "Jind", "Kaithal", "Karnal", "Kurukshetra", "Mahendragarh", "Nuh",
                                "Palwal", "Panchkula", "Panipat", "Rewari", "Rohtak", "Sirsa", "Sonipat",
                                "Yamunanagar")),
                createState("himachal-pradesh", "HP", "Himachal Pradesh", "Shimla",
                        "Complete preparation portal for Himachal Pradesh PSC and sub-ordinate exams.", "STATE",
                        Arrays.asList("Bilaspur", "Chamba", "Hamirpur", "Kangra", "Kinnaur", "Kullu",
                                "Lahaul and Spiti", "Mandi", "Shimla", "Sirmaur", "Solan", "Una")),
                createState("jharkhand", "JH", "Jharkhand", "Ranchi",
                        "Study resources for JPSC, JSSC, and state-level government jobs.", "STATE",
                        Arrays.asList("Bokaro", "Chatra", "Deoghar", "Dhanbad", "Dumka", "East Singhbhum", "Garhwa",
                ...
                createState("karnataka", "KA", "Karnataka", "Bengaluru",
                        "Preparation portal for KPSC, Karnataka Police, and state government jobs.", "STATE",
                        Arrays.asList("Bagalkot", "Ballari", "Belagavi", "Bengaluru Rural", "Bengaluru Urban", "Bidar",
                                "Chamarajanagar", "Chikkaballapur", "Chikkamagaluru", "Chitradurga", "Dakshina Kannada",
                                "Davanagere", "Dharwad", "Gadag", "Hassan", "Haveri", "Kalaburagi", "Kodagu", "Kolar",
                                "Koppal", "Mandya", "Mysuru", "Raichur", "Ramanagara", "Shivamogga", "Tumakuru",
                                "Udupi", "Uttara Kannada", "Vijayapura", "Yadgir")),
                createState("kerala", "KL", "Kerala", "Thiruvananthapuram",
                        "Extensive guide for Kerala PSC, KAS, and sub-ordinate recruitment examinations.", "STATE",
                        Arrays.asList("Alappuzha", "Ernakulam", "Idukki", "Kannur", "Kasaragod", "Kollam", "Kottayam",
                                "Kozhikode", "Malappuram", "Palakkad", "Pathanamthitta", "Thiruvananthapuram",
                                "Thrissur", "Wayanad")),
                createState("madhya-pradesh", "MP", "Madhya Pradesh", "Bhopal",
                        "Comprehensive notes and blueprint for MPPSC and Vyapam exams.", "STATE",
                        Arrays.asList("Agar Malwa", "Alirajpur", "Anuppur", "Ashoknagar", "Balaghat", "Barwani",
                ...
                createState("manipur", "MN", "Manipur", "Imphal",
                        "Study materials for Manipur Public Service Commission and state-level examinations.", "STATE",
                        Arrays.asList("Bishnupur", "Chandel", "Churachandpur", "Imphal East", "Imphal West", "Jiribam",
                                "Kakching", "Kamjong", "Kangpokpi", "Noney", "Pherzawl", "Senapati", "Tamenglong",
                                "Tengnoupal", "Thoubal", "Ukhrul")),
                createState("meghalaya", "ML", "Meghalaya", "Shillong",
                        "Preparation portal for Meghalaya Public Service Commission and sub-ordinate exams.", "STATE",
                        Arrays.asList("East Garo Hills", "East Jaintia Hills", "East Khasi Hills",
                ...
                createState("mizoram", "MZ", "Mizoram", "Aizawl",
                        "Study notes and resources for Mizoram Public Service Commission examinations.", "STATE",
                        Arrays.asList("Aizawl", "Champhai", "Hnahthial", "Khawzawl", "Kolasib", "Lawngtlai", "Lunglei",
                                "Mamit", "Saiha", "Saitual", "Serchhip")),
                createState("nagaland", "NL", "Nagaland", "Kohima",
                        "Complete prep guide for Nagaland Public Service Commission examinations.", "STATE",
                        Arrays.asList("ChÃ¼moukedim", "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung", "Mon",
                                "Niuland", "Noklak", "Peren", "Phek", "Shamator", "TseminyÃ¼", "Tuensang", "Wokha",
                                "Zunheboto")),
                createState("odisha", "OR", "Odisha", "Bhubaneswar",
                        "Comprehensive prep material for OPSC and Odisha State Government exams.", "STATE",
                        Arrays.asList("Angul", "Balangir", "Balasore", "Bargarh", "Bhadrak", "Boudh", "Cuttack",
                ...
                createState("punjab", "PB", "Punjab", "Chandigarh",
                        "Complete study material for PPSC and Punjab state examinations.", "STATE",
                        Arrays.asList("Amritsar", "Barnala", "Bathinda", "Faridkot", "Fatehgarh Sahib", "Fazilka",
                ...
                createState("rajasthan", "RJ", "Rajasthan", "Jaipur",
                        "RAS Prelims and Mains study textbooks and question bank modules.", "STATE",
                        Arrays.asList("Ajmer", "Alwar", "Banswara", "Baran", "Barmer", "Bharatpur", "Bhilwara",
                                "Bikaner", "Bundi", "Chittorgarh", "Churu", "Dausa", "Dholpur", "Dungarpur",
                                "Hanumangarh", "Jaipur", "Jaisalmer", "Jalore", "Jhalawar", "Jhunjhunu", "Jodhpur",
                                "Karauli", "Kota", "Nagaur", "Pali", "Pratapgarh", "Rajsamand", "Sawai Modhopur",
                                "Sikar", "Sirohi", "Sri Ganganagar", "Tonk", "Udaipur")),
                createState("sikkim", "SK", "Sikkim", "Gangtok",
                        "Study resources for Sikkim Public Service Commission and state-level exams.", "STATE",
                        Arrays.asList("Gyalshing", "Mangan", "Namchi", "Pakyong", "Soreng", "Gangtok")),
                createState("tamil-nadu", "TN", "Tamil Nadu", "Chennai",
                        "Comprehensive notes and question banks for TNPSC exams.", "STATE",
                        Arrays.asList("Ariyalur", "Chengalpattu", "Chennai", "Coimbatore", "Cuddalore", "Dharmapuri",
                ...
                createState("telangana", "TG", "Telangana", "Hyderabad",
                        "Study materials and model answers for TSPSC civil services exams.", "STATE",
                        Arrays.asList("Adilabad", "Bhadradri Kothagudem", "Hanamkonda", "Hyderabad", "Jagtial",
                                "Jangaon", "Jayashankar Bhupally", "Jogulamba Gadwal", "Kama Reddy", "Karimnagar",
                ...
                createState("tripura", "TR", "Tripura", "Agartala",
                        "Complete prep resources for TPSC and state government exams.", "STATE",
                        Arrays.asList("Dhalai", "Gomati", "Khowai", "North Tripura", "Sepahijala", "South Tripura",
                                "Unakoti", "West Tripura")),
                createState("uttar-pradesh", "UP", "Uttar Pradesh", "Lucknow",
                        "UPPSC civil service mains solved answers and booster notes.", "STATE",
                        Arrays.asList("Agra", "Aligarh", "Ambedkar Nagar", "Amethi", "Amroha", "Auraiya", "Ayodhya",
                                ...
                                "Varanasi")),
                createState("uttarakhand", "UK", "Uttarakhand", "Dehradun",
                        "Complete prep portal for UKPSC and state government exams.", "STATE",
                        Arrays.asList("Almora", "Bageshwar", "Chamoli", "Champawat", "Dehradun", "Haridwar", "Nainital",
                                "Pauri Garhwal", "Pithoragarh", "Rudraprayag", "Tehri Garhwal", "Udham Singh Nagar",
                                "Uttarkashi")),
                createState("west-bengal", "WB", "West Bengal", "Kolkata",
                        "WBCS Mains solved textbooks and General Knowledge companion.", "STATE",
                        Arrays.asList("Alipurduar", "Bankura", "Birbhum", "Cooch Behar", "Dakshin Dinajpur",
                ...
                // UTs
                createState("andaman-nicobar", "AN", "Andaman and Nicobar Islands", "Port Blair",
                        "Study materials for Andaman and Nicobar Islands administration and related examinations.",
                        "UT", Arrays.asList("Nicobar", "North and Middle Andaman", "South Andaman")),
                createState("chandigarh", "CH", "Chandigarh", "Chandigarh",
                        "Preparation material for Chandigarh Union Territory administration examinations.", "UT",
                        Arrays.asList("Chandigarh")),
                createState("dnh-dd", "DH", "Dadra and Nagar Haveli and Daman and Diu", "Daman",
                        "Study resources for Dadra and Nagar Haveli and Daman and Diu administration exams.", "UT",
                        Arrays.asList("Dadra and Nagar Haveli", "Daman", "Diu")),
                createState("delhi", "DL", "Delhi (National Capital Territory)", "New Delhi",
                        "Comprehensive resource for Delhi Subordinate Services Selection Board, Police, and other examinations.",
                        "UT",
                        Arrays.asList("Central Delhi", "East Delhi", "New Delhi", "North Delhi", "North East Delhi",
                                "North West Delhi", "Shahdara", "South Delhi", "South East Delhi", "South West Delhi",
                                "West Delhi")),
                createState("jammu-kashmir", "JK", "Jammu and Kashmir", "Srinagar (Summer), Jammu (Winter)",
                        "Complete study material for Jammu and Kashmir Public Service Commission and state examinations.",
                        "UT",
                        Arrays.asList("Anantnag", "Bandipora", "Baramulla", "Budgam", "Doda", "Ganderbal", "Jammu",
                                "Kathua", "Kishtwar", "Kulgam", "Kupwara", "Mandy", "Poonch", "Pulwama", "Rajouri",
                                "Ramban", "Reasi", "Samba", "Shopian", "Srinagar", "Udhampur")),
                createState("ladakh", "LA", "Ladakh", "Leh",
                        "Preparation materials for Ladakh Union Territory administration and related exams.", "UT",
                        Arrays.asList("Kargil", "Leh")),
                createState("lakshadweep", "LD", "Lakshadweep", "Kavaratti",
                        "Study materials for Lakshadweep Union Territory administration examinations.", "UT",
                        Arrays.asList("Lakshadweep")),
    ...
    private void migrateImportedProducts() {
        ...
        java.util.function.Consumer<java.util.List<Product>> resolver = list -> {
            ...
            if (oldest == null || startIndex >= list.size() - 1)
                return; // No duplicates left
            ...
            if (oldest.getGoogleDriveFileId() == null || oldest.getGoogleDriveFileId().trim().isEmpty()) {
                for (int i = startIndex + 1; i < list.size(); i++) {
                    ...
                    if (dup.getGoogleDriveFileId() != null && !dup.getGoogleDriveFileId().trim().isEmpty()) {
                        ...
                        log.info("Backfilled googleDriveFileId {} to oldest product {}", dup.getGoogleDriveFileId(),
                                oldest.getId());
                        break;
                    }
                }
            ...
            for (int i = startIndex + 1; i < list.size(); i++) {
                ...
                if (!deletedIds.contains(dup.getId())) {
                    ...
                    log.info("Deleted duplicate product record: id={}, title={}, createdAt={}", dup.getId(),
                            dup.getTitle(), dup.getCreatedAt());
                }
            }
        };
        ...
        for (java.util.List<Product> group : byFileName.values()) {
            ...
            for (Product p : group) {
                String pathKey = (p.getState() != null ? p.getState() : "") + "|"
        ...
        // Backfill metadata on imported-from-Drive products and auto-publish any that
        // are still unpublished
        // FIXED: Only load imported products that need backfill — not the entire
        // collection
        ...
        for (Product p : remainingProducts) {
            ...
            if (isImported) {
                ...
                if (p.getMimeType() == null || p.getMimeType().isEmpty()) {
                    String mt = Product
                            .determineMimeType(p.getFileName() != null ? p.getFileName() : p.getStorageKey());
                    p.setMimeType(mt);
                    changed = true;
                }
                if (p.getContentType() == null || p.getContentType().isEmpty()) {
                    String ct = Product.determineContentType(p.getMimeType(),
                            p.getFileName() != null ? p.getFileName() : p.getStorageKey());
                    p.setContentType(ct);
                    p.setType(ct);
                    changed = true;
                }
                ...
                if (p.getDisplayTitle() == null || p.getDisplayTitle().isEmpty()) {
                    p.setDisplayTitle(
                            Product.stripExtension(p.getTitle() != null ? p.getTitle() : p.getOriginalFileName()));
                ...
                if (p.getFileExtension() == null || p.getFileExtension().isEmpty()) {
                    p.setFileExtension(
                            Product.getFileExtension(p.getFileName() != null ? p.getFileName() : p.getStorageKey()));
                    changed = true;
                }
        ...
        // Programmatically enforce unique sparse indexes in MongoDB to guarantee
        // uniqueness.
        // Drop any existing conflicting index first (IndexOptionsConflict code 85)
        // before re-creating.
    ...
    /**
     * Safely ensures a unique sparse index on a given field in the products
     * collection.
     * If an existing index with the same key but different options (e.g.
     * non-sparse) is found,
    ...
    private void ensureUniqueSparseIndex(String fieldName) {
        ...
        try {
            ...
            if (msg.contains("IndexOptionsConflict") || msg.contains("already exists with a different name")
                ...
                try {
                    ...
                    log.warn("Could not drop index '{}' by name ({}), trying field-based drop.", fieldName,
                            dropEx.getMessage());
                    // Fallback: fetch all indexes, find any that covers this field, and drop by
                    // name
                    try {
                        for (org.springframework.data.mongodb.core.index.IndexInfo info : indexOps.getIndexInfo()) {
                            ...
                            if (coversField && !info.getName().equals("_id_")) {
                                ...
                                log.info("Dropped conflicting index '{}' covering field '{}'.", info.getName(),
                                        fieldName);
                            }
                        }
                ...
                try {
                    ...
                    log.error("Failed to create unique sparse index on '{}' after drop: {}", fieldName,
                            retryEx.getMessage());
                }
            } else {
