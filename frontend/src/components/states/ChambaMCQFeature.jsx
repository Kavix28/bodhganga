        ...
        return (
            <div className="flex flex-col lg:flex-row gap-6 relative items-start">
                ...
                <div className="flex-1 w-full space-y-6">
                    <div className="sticky top-0 bg-gray-950/95 backdrop-blur-sm border border-gray-800 py-3.5 px-4 z-10 flex items-center justify-between rounded-xl">
                        <div className="flex items-center gap-3">
                            <span className="text-xs uppercase font-extrabold tracking-wider text-gray-400">Time Remaining:</span>
                            <span className={`text-xl font-mono font-bold tracking-tight transition-colors ${timerColor}`}>
                                {formatTime(timeLeft)}
                            </span>
                        </div>
                        <div className="flex gap-2">
                            <button
                                ...
                                className="px-3.5 py-1.5 bg-gray-900 hover:bg-gray-850 text-gray-200 border border-gray-800 rounded-lg text-xs font-bold transition-colors"
                            >
                                Test Summary
                            </button>
                            <button
                                onClick={() => setShowSubmitConfirm(true)}
                                className="px-4 py-1.5 bg-amber-500 hover:bg-amber-400 text-black rounded-lg text-xs font-extrabold transition-colors"
                            >
                                Submit Test
                            </button>
                        </div>
                ...
                <div className="hidden lg:flex w-72 bg-gray-900 border border-gray-800 rounded-xl p-5 sticky top-24 shrink-0 flex-col h-[calc(100vh-140px)] space-y-4">
                    <h3 className="text-sm font-bold text-gray-300 uppercase tracking-wider pb-2 border-b border-gray-800">
